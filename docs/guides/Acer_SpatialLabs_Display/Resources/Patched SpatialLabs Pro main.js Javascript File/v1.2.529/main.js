...
require("source-map-support/source-map-support.js").install(), module.exports = function(e) {
	...
	class RegistryManager {
		...
		initDisplayService(e) {
			e.displayName = "" === e.displayName ? "SpatialLabs Display Service" : e.displayName, e.executable = "" === e.executable ? "C:\\Program Files\\Acer\\SpatialLabs\\Display Service\\SpatialLabs Display Service.exe" : e.executable, e.installationPath = "" === e.installationPath ? "C:\\Program Files\\Acer\\SpatialLabs\\Display Service" : e.installationPath, e.type = "" === e.type ? "Service" : e.type, e.uninstallString = "" === e.uninstallString ? "MsiExec.exe /QN /X{7B1A141C-45F8-4069-96CA-9DC1B295D7D5}" : e.uninstallString, e.version = "" === e.version ? "0.03.2039" : e.version
		}
		initOpenXR(e) {
	...
	(function(e) {
		...
		var y, S = Array.prototype,
			...
			D = v.toString,
			k = _.hasOwnProperty,
			A = (y = /[^.]+$/.exec(E && E.keys && E.keys.IE_PROTO || "")) ? "Symbol(src)_1." + y : "",
			C = _.toString,
