...
require("source-map-support/source-map-support.js").install(), module.exports = function(e) {
	...
	class Util {
		constructor() {
			this.bIn3DView = !1, this._env = c.Env.getInstance(), this._window = l.Window.getInstance(), this._i18n = d.I18n.getInstance(), this._log = h.LogIt.getInstance(), this._admin = p.Admin.getInstance(), this._widgetRoot = g.join(r.app.getPath("appData"), "SpatialLabs"), this._osdWindow = m.OSDWindow.getInstance(), this._regObjArray = new Array, this._isPowerPlugged = !0, this._isStress = !1, this.mainWindow = null
		}
		static getInstance() {
		...
		getPublicUrl(e = !1) {
			...
			return Boolean(Number(n)) && (t = "https://d2lugipnt3lgwh.cloudfront.net/SpatialLabs%20Experience%20Center%20DS1PRO"), t
		}
		isDepthRangeMode() {
		...
		isXRControlPanel() {
			const e = this.getRegistryValue("HKEY_LOCAL_MACHINE\\SOFTWARE\\Acer\\SpatialLabs", "XR_CONTROLPANEL");
			return Boolean(Number(e))
		}
		cameraLedControl(e) {
	...
	class Admin {
		...
		getXROSDCombinationKey() {
			return null === o.getSync("XROSDCombinationKey") || void 0 === o.getSync("XROSDCombinationKey") ? "C" : o.getSync("XROSDCombinationKey")
		}
		setXROSDCombinationKey(e) {
			o.setSync("XROSDCombinationKey", e)
		}
		getJson() {
	...
	class WidgetManager {
		...
		runAsAdmin(e, t) {
			return new Promise((n, i) => {
				const r = y.connect("\\\\.\\pipe\\spatiallabspipe", () => {
					console.log("Client: on connection");
					const i = {
							cmd: "Launch",
							exe: e,
		...
		clearTmpDir() {
			...
			if (u.existsSync(e)) {
				u.readdirSync(e).forEach(t => {
					if (t.startsWith("StereoGenerationService.") || t.startsWith("SpatialLabsDisplayService.") || t.startsWith("AcerXRService.") || t.startsWith("srplayer-") || t.startsWith("SR-") || t.startsWith("modelviewer_setup_")) {
						const n = r.join(e, t);
						try {
							u.unlinkSync(n)
						} catch (e) {
		...
		checkMSIX() {
			...
			h.exec('powershell -command "Get-AppxPackage -Name AcerIncorporated.TrueGame"', (n, r, o) => i(this, void 0, void 0, (function*() {
				if (r && (!t || !r.includes(": " + t.version))) {
					let n, i;
					if (r.split("\r\n").forEach(e => {
							e.includes(":") && (e.startsWith("Version") ? n = e.split(":")[1].trim() : e.startsWith("PackageFullName") && (i = e.split(":")[1].trim()))
						}), !t || l.compare(n, t.version, ">")) {
						const t = [{
							key: "HKEY_LOCAL_MACHINE\\SOFTWARE\\Acer\\SpatialLabs\\" + e,
							value: [`"Version"="${n}"`, '"UninstallString"="powershell -command \\"Get-AppxPackage *truegame* -AllUsers | Remove-AppxPackage -AllUsers\\""']
						}];
		...
		beforeLaunch() {
			...
			if (!this._immerseAudioCheck) {
				...
				if ("ACR0002" === this._util.getMainMonitor()) try {
		...
		initShortcut() {
			this.setShortcut("Alt + " + this._admin.getCombinationKey()), this.setStopShortcut("Alt + " + this._admin.getStopCombinationKey()), this.setXROSDShortcut("Alt + " + this._admin.getXROSDCombinationKey())
		}
		setStopShortcut(e) {
		...
		setXROSDShortcut(e) {
			o.app.isReady() && this._xrOSDShortcut && o.globalShortcut.unregister(this.getXROSDShortcut(!0)), this._xrOSDShortcut = e, this._admin.setXROSDCombinationKey(this._xrOSDShortcut.substr(-1)), o.app.isReady() && o.globalShortcut.register(this.getXROSDShortcut(!0), () => i(this, void 0, void 0, (function*() {
				const e = r.join(r.dirname(o.app.getPath("exe")), "win32/OSDHelper.exe");
				if (u.existsSync(e)) try {
					h.execSync("powershell -command \"Get-Process -Name 'OSDHelper'\"")
				} catch (t) {
					this._log.writeLog("OSDHelper is not exist"), this._log.writeLog(`exec "${e}"`), h.exec(`"${e}"`)
				}
			})))
		}
		getXROSDShortcut(e) {
			return e ? this._xrOSDShortcut.replace("Ctrl", "CommandOrControl") : this._xrOSDShortcut
		}
		getVersion(e) {
			let t = "0.0";
			...
			return i(this, void 0, void 0, (function*() {
				...
				if (u.existsSync(a) && !o || (u.existsSync(r.dirname(a)) || u.mkdirSync(r.dirname(a)), yield this.downloadFile(c, s.downloadUrl).then(e => {
					...
					h.exec(`"${r.join(a)}" ${e} /D=${s.installPath}`, (e, r, a) => i(this, void 0, void 0, (function*() {
						e ? (this._log.writeLog("Plugin error: " + e), S.Util.getInstance().showMessageBox({
					...
					this._log.writeLog(`execSync ${r.join(a)}: ${e}`), S.Util.getInstance().showMessageBox({
						title: g.I18n.getInstance().__("Install_Failed")
					}), t(), u.unlinkSync(a)
				} else t()
			}))
					...
					if (u.existsSync(e) || (u.existsSync(r.dirname(e)) || u.mkdirSync(r.dirname(e)), yield this.downloadFile(e, o.downloadUrl).catch(t => {
						...
						if (this.endDownload(), "updatable" === o.status ? this._tmpStatus = "updating" : "downloadable" === o.status && (this._tmpStatus = "installing"), setTimeout(() => {
							...
							if (yield this.runAsAdmin("msiexec", `/QN /I "${r.join(e)}"`).catch(e => {
									this._tmpStatus = void 0, this._log.writeLog("runAsAdmin ERROR: " + e), this._log.writeLog("Message: " + e.message), S.Util.getInstance().showMessageBox({
										title: g.I18n.getInstance().__("Install_Failed")
							...
							this._audioService && (s = 1e3, this._log.writeLog("stop AcerImmerseAudioService"), yield this._util.runAsAdmin("sc", "stop AcerImmerseAudioService").catch(e => {
								...
								this.runAsAdmin(`"${r.join(e)}"`, `${o.installArgument} /D=${o.installPath}`).then(r => {
									if (this._tmpStatus = void 0, r.result) setTimeout(() => i(this, void 0, void 0, (function*() {
										...
										let e;
										e = r.exitcode && 2 == r.exitcode ? g.I18n.getInstance().__("Incompatible_Device") : g.I18n.getInstance().__("Install_Failed"), S.Util.getInstance().showMessageBox({
											title: e
										}), t()
									}
								}).catch(e => {
									this._tmpStatus = void 0, this._log.writeLog("Simulated Reality error: " + e), S.Util.getInstance().showMessageBox({
										title: g.I18n.getInstance().__("Install_Failed")
									}), t()
								})
							}, s)
							...
							this._tmpStatus = void 0, r ? (this._log.writeLog("App error: " + r), S.Util.getInstance().showMessageBox({
								title: g.I18n.getInstance().__("Install_Failed")
						...
						this._tmpStatus = void 0, this._log.writeLog(`execSync ${r.join(e)}: ${n}`), S.Util.getInstance().showMessageBox({
							title: g.I18n.getInstance().__("Install_Failed")
						}), t(), u.unlinkSync(e)
					} else t();
		...
		downloadFile(e, t) {
			...
			return this._online = !0, this._interrupt = !1, t && !t.startsWith("http") && (t = new URL(`${this._ota}/${t}`).href), this._downloadSize = 0, new Promise((i, r) => {
				...
				o.on("close", () => {
					...
					p.LogIt.getInstance().writeLog("writeStream error: " + e), S.Util.getInstance().showMessageBox({
				...
				c.on("response", (function(e) {
					p.LogIt.getInstance().writeLog("request response: " + e), e && e.statusCode && 200 != e.statusCode && (S.Util.getInstance().showMessageBox({
						title: g.I18n.getInstance().__("Disconnected"),
						...
						WidgetManager.getInstance().isInterrupt() && (r("Interrupt by User"), o.close(), c.abort(), clearInterval(n)), WidgetManager.getInstance().isOnline() || (S.Util.getInstance().showMessageBox({
							title: g.I18n.getInstance().__("Disconnected"),
							message: g.I18n.getInstance().__("Disconnected_Info")
					...
					p.LogIt.getInstance().writeLog("request error: " + e), S.Util.getInstance().showMessageBox({
						title: g.I18n.getInstance().__("Disconnected"),
						message: g.I18n.getInstance().__("Disconnected_Info")
					}), r(e), o.close(), c.abort(), s && s.object && s.object.webContents && s.object.webContents.send("download-progress", {
						length: void 0,
		...
		getInitPlugins() {
			return [{
				...
				description: {
					...
					ja: "このアドオンは、Zbrushで 3D モデルを取得して、自動的に SpatialLabs Model Viewer にエクスポートできるショートカットとして機能します。このアドオンは、それぞれのソフトウェアバージョンに対してインストールする必要があります。",
					...
					uk: "Надбудова служить ярликом, який дозволяє вам брати ваші 3D-моделі в Zbrush і автоматично експортувати їх у SpatialLabs Model Viewer. Вам потрібно встановити доповнення для кожної версії програмного забезпечення відповідно.",
					th: "ส่วนเสริมทำหน้าที่เป็นทางลัดที่ให้คุณนำโมเดล 3 มิติของคุณใน Zbrush และส่งออกโมเดลเหล่านั้นไปยัง SpatialLabs Model Viewer โดยอัตโนมัติ คุณต้องติดตั้งส่วนเสริมสำหรับซอฟต์แวร์แต่ละเวอร์ชันตามลำดับ"
				},
				downloadUrl: "../SpatialLabs MV addons/v1.7.3/zbrush_setup_1.7.3.exe",
				infoUrl: "https://go.acer.com/user-guide-spatiallabs-view-pro",
				...
				displayName: {
					...
					uk: "Надбудова SketchUp",
					th: "SketchUp เพิ่มเข้าไป"
				},
				type: "Add-on",
				version: "1.7.2",
				description: {
					...
					ja: "このアドオンは、SketchUpで 3D モデルを取得して、自動的に SpatialLabs Model Viewer にエクスポートできるショートカットとして機能します。このアドオンは、それぞれのソフトウェアバージョンに対してインストールする必要があります。",
					...
					uk: "Надбудова служить ярликом, який дозволяє вам брати ваші 3D-моделі в SketchUp і автоматично експортувати їх у SpatialLabs Model Viewer. Вам потрібно встановити доповнення для кожної версії програмного забезпечення відповідно.",
					th: "ส่วนเสริมทำหน้าที่เป็นทางลัดที่ให้คุณนำโมเดล 3 มิติของคุณใน SketchUp และส่งออกโมเดลเหล่านั้นไปยัง SpatialLabs Model Viewer โดยอัตโนมัติ คุณต้องติดตั้งส่วนเสริมสำหรับซอฟต์แวร์แต่ละเวอร์ชันตามลำดับ"
				},
				...
				displayName: {
					...
					uk: "Надбудова Fusion 360",
					th: "Fusion 360 เพิ่มเข้าไป"
				},
				type: "Add-on",
				version: "1.7.5",
				description: {
					...
					ja: "このアドオンは、Fusion 360で 3D モデルを取得して、自動的に SpatialLabs Model Viewer にエクスポートできるショートカットとして機能します。このアドオンは、それぞれのソフトウェアバージョンに対してインストールする必要があります。",
					...
					uk: "Надбудова служить ярликом, який дозволяє вам брати ваші 3D-моделі в Fusion 360 і автоматично експортувати їх у SpatialLabs Model Viewer. Вам потрібно встановити доповнення для кожної версії програмного забезпечення відповідно.",
					th: "ส่วนเสริมทำหน้าที่เป็นทางลัดที่ให้คุณนำโมเดล 3 มิติของคุณใน Fusion 360 และส่งออกโมเดลเหล่านั้นไปยัง SpatialLabs Model Viewer โดยอัตโนมัติ คุณต้องติดตั้งส่วนเสริมสำหรับซอฟต์แวร์แต่ละเวอร์ชันตามลำดับ"
				},
				...
				description: {
					...
					ja: "このアドオンは、Curaで 3D モデルを取得して、自動的に SpatialLabs Model Viewer にエクスポートできるショートカットとして機能します。このアドオンは、それぞれのソフトウェアバージョンに対してインストールする必要があります。",
					...
					uk: "Надбудова служить ярликом, який дозволяє вам брати ваші 3D-моделі в Cura і автоматично експортувати їх у SpatialLabs Model Viewer. Вам потрібно встановити доповнення для кожної версії програмного забезпечення відповідно.",
					th: "ส่วนเสริมทำหน้าที่เป็นทางลัดที่ให้คุณนำโมเดล 3 มิติของคุณใน Cura และส่งออกโมเดลเหล่านั้นไปยัง SpatialLabs Model Viewer โดยอัตโนมัติ คุณต้องติดตั้งส่วนเสริมสำหรับซอฟต์แวร์แต่ละเวอร์ชันตามลำดับ"
				},
				downloadUrl: "../SpatialLabs MV addons/v1.7.4/cura_setup_1.7.4.exe",
				infoUrl: "https://go.acer.com/user-guide-spatiallabs-view-pro",
				installArgument: "/VERYSILENT /SUPPRESSMSGBOXES",
				...
				displayName: {
					...
					uk: "Надбудова Blender",
					th: "Blender เพิ่มเข้าไป"
				},
				type: "Add-on",
				version: "1.7.1",
				description: {
					...
					ja: "このアドオンは、Blenderで 3D モデルを取得して、自動的に SpatialLabs Model Viewer にエクスポートできるショートカットとして機能します。このアドオンは、それぞれのソフトウェアバージョンに対してインストールする必要があります。",
					...
					uk: "Надбудова служить ярликом, який дозволяє вам брати ваші 3D-моделі в Blender і автоматично експортувати їх у SpatialLabs Model Viewer. Вам потрібно встановити доповнення для кожної версії програмного забезпечення відповідно.",
					th: "ส่วนเสริมทำหน้าที่เป็นทางลัดที่ให้คุณนำโมเดล 3 มิติของคุณใน Blender และส่งออกโมเดลเหล่านั้นไปยัง SpatialLabs Model Viewer โดยอัตโนมัติ คุณต้องติดตั้งส่วนเสริมสำหรับซอฟต์แวร์แต่ละเวอร์ชันตามลำดับ"
				},
				...
				description: {
					...
					ja: "このアドオンは、Rhinoで 3D モデルを取得して、自動的に SpatialLabs Model Viewer にエクスポートできるショートカットとして機能します。このアドオンは、それぞれのソフトウェアバージョンに対してインストールする必要があります。",
					...
					uk: "Надбудова служить ярликом, який дозволяє вам брати ваші 3D-моделі в Rhino і автоматично експортувати їх у SpatialLabs Model Viewer. Вам потрібно встановити доповнення для кожної версії програмного забезпечення відповідно.",
					th: "ส่วนเสริมทำหน้าที่เป็นทางลัดที่ให้คุณนำโมเดล 3 มิติของคุณใน Rhino และส่งออกโมเดลเหล่านั้นไปยัง SpatialLabs Model Viewer โดยอัตโนมัติ คุณต้องติดตั้งส่วนเสริมสำหรับซอฟต์แวร์แต่ละเวอร์ชันตามลำดับ"
				},
				...
				displayName: {
					...
					uk: "Надбудова 3ds Max",
					th: "3ds Max เพิ่มเข้าไป"
				},
				type: "Add-on",
				version: "1.7.2",
				description: {
					...
					ja: "このアドオンは、3ds Maxで 3D モデルを取得して、自動的に SpatialLabs Model Viewer にエクスポートできるショートカットとして機能します。このアドオンは、それぞれのソフトウェアバージョンに対してインストールする必要があります。",
					...
					uk: "Надбудова служить ярликом, який дозволяє вам брати ваші 3D-моделі в 3ds Max і автоматично експортувати їх у SpatialLabs Model Viewer. Вам потрібно встановити доповнення для кожної версії програмного забезпечення відповідно.",
					th: "ส่วนเสริมทำหน้าที่เป็นทางลัดที่ให้คุณนำโมเดล 3 มิติของคุณใน 3ds Max และส่งออกโมเดลเหล่านั้นไปยัง SpatialLabs Model Viewer โดยอัตโนมัติ คุณต้องติดตั้งส่วนเสริมสำหรับซอฟต์แวร์แต่ละเวอร์ชันตามลำดับ"
				},
				...
				displayName: {
					...
					uk: "Надбудова Inventor",
					th: "Inventor เพิ่มเข้าไป"
				},
				type: "Add-on",
				version: "1.7.2",
				description: {
					...
					ja: "このアドオンは、Inventorで 3D モデルを取得して、自動的に SpatialLabs Model Viewer にエクスポートできるショートカットとして機能します。このアドオンは、それぞれのソフトウェアバージョンに対してインストールする必要があります。",
					...
					uk: "Надбудова служить ярликом, який дозволяє вам брати ваші 3D-моделі в Inventor і автоматично експортувати їх у SpatialLabs Model Viewer. Вам потрібно встановити доповнення для кожної версії програмного забезпечення відповідно.",
					th: "ส่วนเสริมทำหน้าที่เป็นทางลัดที่ให้คุณนำโมเดล 3 มิติของคุณใน Inventor และส่งออกโมเดลเหล่านั้นไปยัง SpatialLabs Model Viewer โดยอัตโนมัติ คุณต้องติดตั้งส่วนเสริมสำหรับซอฟต์แวร์แต่ละเวอร์ชันตามลำดับ"
				},
				...
				version: "1.5.1.2702",
				description: {
					en: "PiStage serves as a bridge to easily transfer your Maya project into Unreal Engine, which allows real-time review of your project in UE and in Stereoscopic 3D Mode.",
					fr: "PiStage sert de passerelle pour transférer facilement votre projet Maya dans Unreal Engine, ce qui permet de revoir votre projet en temps réel dans UE et en mode 3D stéréoscopique.",
					ja: "PiStage は、Maya プロジェクトを Unreal Engine に簡単に転送できるブリッジとして機能します。これは、UE とステレオスコピック 3D モードでのプロジェクトのリアルタイムレビューを可能にします。",
					"zh-TW": "PiStage 可做為輕鬆將您的 Maya 專案轉移到 Unreal Engine 的橋樑，讓您在 UE 和 3D 立體視覺模式中即時檢視專案。",
					"zh-CN": "PiStage 作为一个桥梁，可轻松地将 Maya 项目转换到 Unreal Engine，以在 UE 和 3D 模式下实时检查您的项目。",
					de: "PiStage dient als Brücke, um Ihr Maya Projekt einfach in die Unreal Engine zu übertragen, was eine Echtzeitüberprüfung Ihres Projekts in UE und im stereoskopischen 3D Modus ermöglicht.",
					it: "PiStage serve da ponte per il trasferimento semplificato dei progetti Maya in Unreal Engine, che consente di rivedere in tempo reale il progetto in UE e in Modalità 3D stereoscopico.",
					es: "PiStage hace la función de puente para transferir fácilmente su proyecto Maya a Unreal Engine, para que pueda revisar su proyecto en tiempo real en UE y en modo 3D estereoscópico.",
					"pt-PT": "PiStage serve de ponte para transferir facilmente o seu projeto Maya para o Unreal Engine, que permite uma análise em tempo real do seu projeto em UE e no Modo 3D Estereoscópico.",
					nl: "PiStage dient als een brug om eenvoudig een Maya-project naar Unreal Engine over te dragen, voor een realtime voorbeeld van het project in UE en in Stereoscopische 3D-modus.",
					el: "Το PiStage εξυπηρετεί ως γέφυρα για την εύκολη μεταφορά του έργου σας Maya στο Unreal Engine, όπου επιτρέπεται η επανεξέταση του έργου σε πραγματικό χρόνο σε UE και Στερεοσκοπική λειτουργία 3D.",
					sv: "PiStage fungerar som en brygga för att enkelt överföra ditt Maya-projekt till Unreal Engine, vilket möjliggör realtidsgranskning av ditt projekt i UE och i Stereoskopiskt 3D-läge.",
					nb: "PiStage er som en bro for enkel overføring av Maya-prosjektet til Unreal Engine, som tillater sanntidsgjennomgang av prosjektet i UE og i Stereoskopisk 3D-modus.",
					fi: "PiStage toimii siltana ja siirtää Maya-projektisi helposti Unreal Engineen, mikä mahdollistaa projektisi reaaliaikaisen tarkastelun UE:ssä ja 3D-stereotilassa.",
					pl: "PiStage służy jako pomost do łatwego przeniesienia projektu Maya do Unreal Engine, który umożliwia przegląd projektu w czasie rzeczywistym w UE i w trybie stereoskopowym 3D.",
					ru: "Используя PiStage как мост, вы можете ваш проект Maya легко передать в Unreal Engine и в реальном времени просмотреть его в UE и в режиме стереоскопического отображения 3D-материалов.",
					cs: "PiStage slouží jako most pro snadný přenos projektu Maya do Unreal Engine, který umožňuje kontrolu projektu v reálném čase v UE a ve Stereoskopickém 3D režimu.",
					hu: "A PiStage hídként szolgál a Maya projekt egyszerű átviteléhez az Unreal Engine-be, mely lehetővé teszi a projekt valós idejű áttekintését az UE-ben és Stereoscopic 3D módban.",
					tr: "PiStage, Maya projenizi Unreal Engine'e kolayca aktarmak için bir köprü görevi görür; bu, projenizin UE'de ve Stereoskopik 3B Modunda gerçek zamanlı olarak incelenmesine olanak tanır.",
					da: "PiStage tjener som en bro, så det er nemt at overføre dit Maya-projekt til Unreal Engine, der giver mulighed for gennemgang af dit projekt i UE og i Stereoskopisk 3D-tilstand i realtid.",
					bg: "PiStage служи като мост за лесно прехвърляне на Вашия проект в Maya на Unreal Engine, което позволява преглед в реално време на Вашия проект в UE и в Stereoscopic 3D режим.",
					hr: "PiStage služi kao premosnica za jednostavno prenošenje Maya projekta u Unreal Engine što omogućava pregledavanje projekta u UE i u načinu rada Stereoskopskom 3D u stvarnom vremenu.",
					ro: "PiStage are rol de punte pentru a vă transfera cu uşurinţă proiectul Maya în Unreal Engine, şi care permite analizarea în timp real a proiectului dvs. în UE şi modul 3D stereoscopic.",
					sl: "PiStage služi kot most za enostaven prenos projekta Maya v Unreal Engine, kar omogoča pregled projekta v UE in v stereoskopskem načinu 3D v realnem času.",
					sk: "PiStage slúži ako most na jednoduchý prenos vášho projektu Maya do Unreal Engine, ktorý umožňuje kontrolu vášho projektu v reálnom čase v UE a v Stereoskopickom 3D režime.",
					ko: "PiStage는 Maya 프로젝트를 Unreal Engine으로 쉽게 전송하는 다리 역할을 합니다. 이 엔진에서는 프로젝트를 UE 및 입체 3D 모드로 실시간 검토할 수 있습니다.",
					"pt-BR": "O PiStage funciona como uma ponte para transferir facilmente seu projeto Maya para o Unreal Engine, que permite análise em tempo real de seu projeto em UE e no Modo Estereoscópico 3D.",
					uk: "PiStage служить мостом для легкого перенесення вашого проекту Maya в Unreal Engine, який дозволяє переглядати ваш проект у реальному часі в UE та стереоскопічному 3D-режимі.",
					th: "PiStage ทำหน้าที่เป็นสะพานเชื่อมในการถ่ายโอนโปรเจ็กต์ Maya ของคุณไปยัง Unreal Engine ได้อย่างง่ายดาย ซึ่งช่วยให้ตรวจสอบโปรเจ็กต์ของคุณแบบเรียลไทม์ใน UE และในโหมด 3D Stereoscopic"
				},
				downloadUrl: "../PiStage/v1.5.1.2702/PiStage_1.5.1.2702(Build20230102)_SpatialLabs.exe",
				infoUrl: "https://go.acer.com/user-guide-spatiallabs-view-pro",
				icon: "C:\\PiSquare\\PiStage\\PiStage.ico",
				installArgument: "/S",
				uninstallString: "C:\\PiSquare\\PiStage\\uninstall.exe /S"
			}, {
				name: "BlenderView",
				displayName: {
					en: "Blender Stereo",
				...
				description: {
					...
					ja: "このアドオンは、Blender でディスプレイモードを設定するショートカットとして機能し、SpatialLabs Go または組み合わせキーでサイドバイサイドの全画面ステレオスコピック 3D モードでコンテンツを表示します。",
					...
					uk: "Доповнення служить ярликом, який налаштовує режим відображення в Blender для перегляду вмісту в повноекранному режимі Stereoscopic 3D поруч за допомогою SpatialLabs Go або комбінованої клавіші.",
					th: "ส่วนเสริมทำหน้าที่เป็นทางลัดที่กำหนดค่าโหมดการแสดงผลใน Blender เพื่อดูเนื้อหาในโหมด Stereoscopic 3D แบบเต็มหน้าจอเคียงข้างกันด้วย SpatialLabs Go หรือคีย์ผสม"
				},
		...
		getDX12() {
			let e = !this._util.getRegistryValue("HKEY_LOCAL_MACHINE\\SOFTWARE\\Acer\\Acer XR Service", "DX12 Enabled") || this._util.getRegistryValue("HKEY_LOCAL_MACHINE\\SOFTWARE\\Acer\\Acer XR Service", "DX12 Enabled");
			return Boolean(Number(e))
		}
		changeDX12(e) {
			return i(this, void 0, void 0, (function*() {
				const t = [{
					key: "HKEY_LOCAL_MACHINE\\SOFTWARE\\Acer\\Acer XR Service",
					value: ['"DX12 Enabled"=dword:' + Number(e)]
				}];
				yield this._util.pushReg(t)
			}))
		}
		setWeavingType(e) {
	...
	class RegistryManager {
		constructor() {
			this._widgets = new Array, this._plugins = new Array, this._log = p.LogIt.getInstance(), this._acerApps = ["Acer XR Service", "Stereo Generation", "Display Service", "Model Viewer", "Display Go", "VideoCall"], this._dimenceApps = ["Simulated Reality", "Eye Tracker", "Diagnostic", "Player"], this._acerRoot = "HKEY_LOCAL_MACHINE\\SOFTWARE\\Acer\\SpatialLabs", this._dimencoRoot = "HKEY_LOCAL_MACHINE\\SOFTWARE\\Dimenco", this._pluginRoot = "HKEY_LOCAL_MACHINE\\SOFTWARE\\Acer\\SpatialLabs\\Add-ons", this._defaultIcon = "C:\\Program Files\\Acer\\SpatialLabs\\SR Platform\\bin\\Resources\\installed.ico", this._iconRoot = "C:\\Program Files\\Acer\\SpatialLabs\\ExperienceCenter\\resources\\src\\assets\\image", this._util = S.Util.getInstance()
		}
		static getInstance() {
		...
		initSRService(e) {
			e.displayName = "" === e.displayName ? "SRService" : e.displayName, e.executable = "" === e.executable ? "C:\\Program Files\\Acer\\SpatialLabs\\SR Platform\\bin\\SRService.exe" : e.executable, e.installationPath = "" === e.installationPath ? "C:\\Program Files\\Acer\\SpatialLabs\\SR Platform" : e.installationPath, e.type = "" === e.type ? "Service" : e.type, e.uninstallString = "" === e.uninstallString ? "C:\\Program Files\\Acer\\SpatialLabs\\Uninstall.exe /S" : e.uninstallString, e.version = "" === e.version ? "0.30.2" : e.version
		}
		initEyeTracker(e) {
			e.displayName = "" === e.displayName ? "SR Eye Tracker" : e.displayName, e.executable = "" === e.executable ? "C:\\Program Files\\Acer\\SpatialLabs\\SR Eye Tracker\\bin\\SREyeTracker.exe" : e.executable, e.installationPath = "" === e.installationPath ? "C:\\Program Files\\Acer\\SpatialLabs\\SR Eye Tracker" : e.installationPath, e.type = "" === e.type ? "Service" : e.type, e.version = "" === e.version ? "1.8.1" : e.version
		}
		initDiagnostic(e) {
			e.displayName = "" === e.displayName ? "System Status" : e.displayName, e.executable = "" === e.executable ? "C:\\Program Files\\Acer\\SpatialLabs\\System Status\\bin\\System Status.exe" : e.executable, e.installationPath = "" === e.installationPath ? "C:\\Program Files\\Acer\\SpatialLabs\\System Status" : e.installationPath, e.type = "" === e.type ? "Service" : e.type, e.version = "" === e.version ? "0.9.5" : e.version
		}
		initStereoGeneration(e) {
			e.displayName = "" === e.displayName ? "Stereo Generation Service" : e.displayName, e.executable = "" === e.executable ? "C:\\Program Files\\Acer\\SpatialLabs\\Display Service\\GenerateStereo.dll" : e.executable, e.installationPath = "" === e.installationPath ? "C:\\Program Files\\Acer\\SpatialLabs\\Display Service" : e.installationPath, e.type = "" === e.type ? "Service" : e.type, e.uninstallString = "" === e.uninstallString ? "MsiExec.exe /QN /X {41567085-A14F-44C4-A1C8-7A0B83F05683}" : e.uninstallString, e.version = "" === e.version ? "0.03.2017" : e.version
		}
		initDisplayService(e) {
			e.displayName = "" === e.displayName ? "SpatialLabs Display Service" : e.displayName, e.executable = "" === e.executable ? "C:\\Program Files\\Acer\\SpatialLabs\\Display Service\\SpatialLabs Display Service.exe" : e.executable, e.installationPath = "" === e.installationPath ? "C:\\Program Files\\Acer\\SpatialLabs\\Display Service" : e.installationPath, e.type = "" === e.type ? "Service" : e.type, e.uninstallString = "" === e.uninstallString ? "MsiExec.exe /QN /X{AA7A0D44-62BA-4BC5-82B4-4616C87A7FEE}" : e.uninstallString, e.version = "" === e.version ? "0.03.2038" : e.version
		}
		initOpenXR(e) {
		...
		initVideoCall(e) {
			e.displayIcon = "" === e.displayIcon ? r.join(this._iconRoot, "apps", "videocall.ico") : e.displayIcon, e.displayName = "" === e.displayName ? g.I18n.getInstance().__("Video_Call_Display_Name") : e.displayName, e.executable = "" === e.executable ? "C:\\Program Files\\Acer\\SpatialLabs\\VideoCall\\SpatialLabs Video Call.exe" : e.executable, e.installationPath = "" === e.installationPath ? "C:\\Program Files\\Acer\\SpatialLabs\\VideoCall" : e.installationPath, e.type = "" === e.type ? "App" : e.type, e.uninstallString = "" === e.uninstallString ? '"C:\\Program Files\\Acer\\SpatialLabs\\VideoCall\\win32\\SetupLauncher.exe" "C:\\ProgramData\\Package Cache\\{be18710f-7ddb-4e0b-a561-e1a77634109a}\\SpatialLabsVideoCallSetup.exe" /uninstall /quiet' : e.uninstallString, e.version = "" === e.version ? "0.0.12" : e.version, e.description = "" === e.description ? g.I18n.getInstance().__("Video_Call_Desc") : e.description
		}
		addPlugin(e, t, n, i, r) {
			if ("" !== i && "" !== t) {
				if (n) {
	...
	class LockDevice {
		...
		detectHDMI() {
			this._hdmi = !1, this._mainMonitor = "", this._isDS1 = !1, this._hdmiArray.includes(u.HDMI_ACR0000) && (this._log.writeLog("ACER DS1P"), this._hdmi = !0, this._mainMonitor = "ACR0000", this._isDS1 = !0), this._hdmiArray.includes(u.HDMI_ACR0001) && (this._log.writeLog("ACER DS1C"), this._mainMonitor = "ACR0001", this._isDS1 = !0), this._hdmiArray.includes(u.HDMI_ACR0002) && (this._log.writeLog("ACER DS2P"), this._hdmi = !0, this._mainMonitor = "ACR0002", this._isDS1 = !0), this._hdmiArray.includes(u.HDMI_ACR0003) && (this._log.writeLog("ACER DS2C"), this._mainMonitor = "ACR0003", this._isDS1 = !0), this._hdmiArray.includes(u.HDMI_ICD2708) && (this._log.writeLog("ACER DS2"), this._hdmi = !0, this._mainMonitor = "ICD2708", this._isDS1 = !0)
		}
		detectMonitor() {
			return i(this, void 0, void 0, (function*() {
		...
		startDetect() {
			if (!this._util.is3DView()) try {
				r.exec("powershell -command \"Get-PnpDevice -InstanceId 'USB\\VID_*' -Status OK | Select-Object -Property InstanceId\"", (e, t, n) => {
					if (!e) {
						const e = String(t);
				...
				}), r.exec("powershell -command \"Get-PnpDevice -InstanceId 'DISPLAY*' -Status OK | Select-Object -Property InstanceId\"", (e, t, n) => {
					if (!e) {
						const e = String(t);
		...
		lazyLoading() {
			return i(this, void 0, void 0, (function*() {
				this.srNative || (this.srNative = yield Promise.resolve().then(() => n(65)))
			}))
		}
		startListener() {
			return i(this, void 0, void 0, (function*() {
				yield this.lazyLoading();
				this.srNative.startSRSystemListener(e => {
		...
		stopListener() {
			return i(this, void 0, void 0, (function*() {
				yield this.lazyLoading();
				this.srNative.stopSRSystemListener()
			}))
		}
	}
	...
	class OSDWindow {
		...
		show(e, t, n, i = null) {
			...
			let b = !1,
				S = o.get(this.osdName);
			const y = `${this._env.getLocalUrl()}#/${e}`;
			if (S) this._url !== y && (this._url = y, S.object.loadURL(y)), "stereo-info" === e && i && i.title && i.message && (S.object.data = i, S.object.loadURL(y)), S.object.setBounds({
				x: Math.round(a),
				y: Math.round(l),
				width: t,
				height: n
			}), OSDWindow.osdRectangle = S.object.getBounds();
			else {
				const r = o.createNew(this.osdName, "", y, !1, {
					width: t,
					height: n,
					x: Math.round(a),
					y: Math.round(l),
				...
				r.create(), "stereo-info" === e && i && i.title && i.message && (r.object.data = i), r.object.loadURL(y), OSDWindow.osdRectangle = r.object.getBounds(), b = !0, this._url = y, setTimeout(() => {
		...
		lazyLoading() {
			return i(this, void 0, void 0, (function*() {
				this._log.writeLog("lazyLoading in osdWindow"), this.srNative || (this._log.writeLog("srNative lazyLoading in osdWindow"), this.srNative = yield Promise.resolve().then(() => n(65)))
			}))
		}
		close() {
		...
		showStatus(e) {
			...
			if (e || "hide" !== a)
				if (e && ("show" === a ? a = "enlarge" : "enlarge" === a ? a = "hide" : "hide" === a && (a = "show"), this._admin.setOSDStatus(a)), "enlarge" === a ? r = 138 : "show" === a && (r = 112), "hide" === a) this.closeStatus();
					...
					if (y) this._url !== v && (this._url = v, y.object.loadURL(v)), y.object.setBounds({
						x: Math.round(u),
						y: Math.round(d),
						width: i,
						height: r
					}), OSDWindow.statusRectangle = y.object.getBounds();
					else {
						...
						e.create(), e.object.loadURL(v), OSDWindow.statusRectangle = e.object.getBounds(), S = !0, this._url = v, setTimeout(() => {
					...
					this._log.writeLog(`OSD Status Window show: name=${n}, x=${u}, y=${d}, width=${i}, height=${r}, flag=${S}`), S || setTimeout(() => {
	...
	class AppUpdater extends o.EventEmitter {
		...
		async executeDownload(e) {
			...
			const removeFileIfAny = async () => (await c.clear().catch(() => {}), await s.unlink(p).catch(() => {})), S = await d.createTempUpdateFile("temp-" + h, u, m);
			try {
				await e.task(S, n, f, removeFileIfAny), await s.rename(S, p)
			} catch (e) {
	...
	var S = /^[-+]?[0-9]+e/;
	var y = new c("tag:yaml.org,2002:float", {
			kind: "scalar",
	...
	var k = new c("tag:yaml.org,2002:timestamp", {
		kind: "scalar",
	...
	var A = new c("tag:yaml.org,2002:merge", {
			kind: "scalar",
	...
	var R = new c("tag:yaml.org,2002:pairs", {
			kind: "sequence",
	...
	var P = new c("tag:yaml.org,2002:set", {
			...
			resolve: function resolveYamlSet(e) {
				...
				var t, n = e;
				for (t in n)
					if (N.call(n, t) && null !== n[t]) return !1;
				return !0
			},
	...
	for (var $ = new Array(256), H = new Array(256), q = 0; q < 256; q++) $[q] = simpleEscapeSequence(q) ? 1 : 0, H[q] = simpleEscapeSequence(q);
	...
	function composeNode(e, t, n, r, o) {
		...
		if (c && (c = m || o), 1 !== g && 4 !== n || (p = 1 === n || 2 === n ? t : t + 1, f = e.position - e.lineStart, 1 === g ? c && (readBlockSequence(e, f) || function readBlockMapping(e, t, n) {
				...
				for (null !== e.anchor && (e.anchorMap[e.anchor] = h), l = e.input.charCodeAt(e.position); 0 !== l;) {
					if (b || -1 === e.firstTabInLine || (e.position = e.firstTabInLine, throwError(e, "tab characters must not be used in indentation")), i = e.input.charCodeAt(e.position + 1), o = e.line, 63 !== l && 58 !== l || !is_WS_OR_EOL(i)) {
						...
						if (e.line === o) {
							...
							if (58 === l) is_WS_OR_EOL(l = e.input.charCodeAt(++e.position)) || throwError(e, "a whitespace character is expected after the key-value separator within a block mapping"), b && (storeMappingPair(e, h, p, f, g, null, s, a, c), f = g = m = null), S = !0, b = !1, r = !1, f = e.tag, g = e.result;
							else {
								if (!S) return e.tag = u, e.anchor = d, !0;
					...
					} else 63 === l ? (b && (storeMappingPair(e, h, p, f, g, null, s, a, c), f = g = m = null), S = !0, b = !0, r = !0) : b ? (b = !1, r = !0) : throwError(e, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), e.position += 1, l = i;
				...
				return b && storeMappingPair(e, h, p, f, g, null, s, a, c), S && (e.tag = u, e.anchor = d, e.kind = "mapping", e.result = h), S
	...
	function readDocument(e) {
		...
		for (e.version = null, e.checkLineBreaks = e.legacy, e.tagMap = Object.create(null), e.anchorMap = Object.create(null); 0 !== (r = e.input.charCodeAt(e.position)) && (skipSeparationSpace(e, !0, -1), r = e.input.charCodeAt(e.position), !(e.lineIndent > 0 || 37 !== r));) {
			...
			0 !== r && readLineBreak(e), U.call(G, n) ? G[n](e, n, i) : throwWarning(e, 'unknown document directive "' + n + '"')
		}
				...
				v.redirect = "manual", b = t => {
					...
					const h = this.httpExecutor.createRequest(v, e => {
						e.statusCode >= 400 && o(i.createHttpError(e)), e.pipe(m, {
							...
							p && p.endRangeDownload(), 100 == ++S ? (S = 0, setTimeout(() => b(t), 1e3)) : b(t)
						})
					});
					h.on("redirect", (e, t, n) => {
						...
						}(n)), y = n, i.configureRequestUrl(new a.URL(y), v), h.followRedirect()
	...
	class MainApp {
		...
		createMessageCenter() {
			A.createMessageCenter(e => i(this, void 0, void 0, (function*() {
				console.log("Got message: " + e), 2044 === e.message && (this.LogSys.writeLog("AI is initializing"), this.util.showAIInitialing(), this.util.stop3DViewAIInitialing()), this.util.is3DView() && 4024 === e.message && (this.LogSys.writeLog("showStereoInfo"), this.admin.isStereNotification() && this.util.showStereoInfo(), this.util.isStereoGeneration() && this._osdWindow.showStatus(!1)), 1025 === e.message && (this.LogSys.writeLog("receive WM_SLDS_SERVICE_FAILED"), this.util.stop3DViewFailedMessage()), 4026 === e.message && (this.LogSys.writeLog("get msg: WM_FW_WINDOW_CLOSED"), this.util.runAsAdmin("powershell", "-command \"Stop-Process -Name 'OSDHelper'\"").then(e => {
					this.LogSys.writeLog("OSD is closed")
				}).catch(e => {
					this.LogSys.writeLog("OSD is hidden")
				}))
			})));
		...
		registerKey() {
			E.register("CmdOrCtrl+F12", (function() {
				...
				this.convergence < 4 && (this.convergence++, this.util.setConvergence(this.convergence))
			}), s.globalShortcut.register("Alt + O", () => {
				this.convergence > 0 && (this.convergence--, this.util.setConvergence(this.convergence))
			...
			})))), s.globalShortcut.register(this.widgetManger.getXROSDShortcut(!0), () => i(this, void 0, void 0, (function*() {
				const e = a.join(a.dirname(s.app.getPath("exe")), "win32/OSDHelper.exe");
				if (k.existsSync(e)) try {
					N.execSync("powershell -command \"Get-Process -Name 'OSDHelper'\"")
				} catch (t) {
					this.LogSys.writeLog("OSDHelper is not exist"), this.LogSys.writeLog(`exec "${e}"`), N.exec(`"${e}"`)
				}
			})))
		}
		checkShortcut(e) {
			...
			if (t) {
				...
				if (2 === e.length) {
					const t = e[1].split("|"),
						...
						i = t[1],
						r = t[2];
					k.existsSync(this.SMRoot) || k.mkdirSync(this.SMRoot);
					const o = new Array;
					...
					const l = this.serve ? "C:/Program Files/Acer/SpatialLabs/ExperienceCenter/SpatialLabs Experience Center.exe" : c,
						u = A.createShortcut(l, `"${o.join('" "')}"`, a.join(this.SMRoot, n + ".lnk"), r);
	...
	t.EnvConfigBase = class EnvConfigBase {
		constructor() {
			this.appUpdateURL = "https://d3kbld5mjap5ss.cloudfront.net/SpatialLabs%20Experience%20Center%20DS1PRO"
		}
	}
}, function(e, t, n) {
	"use strict";
	...
	t.createTray = (e, t) => {
		...
		"ACR0002" === l.Util.getInstance().getMainMonitor() && u.push({
			type: "separator"
		}, {
			type: "normal",
	...
	(function(e) {
		...
		var S, y = Array.prototype,
			v = Function.prototype,
			_ = Object.prototype,
			E = d["__core-js_shared__"],
			D = v.toString,
			k = _.hasOwnProperty,
			A = (S = /[^.]+$/.exec(E && E.keys && E.keys.IE_PROTO || "")) ? "Symbol(src)_1." + S : "",
			C = _.toString,
			I = RegExp("^" + D.call(k).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
			O = f ? d.Buffer : void 0,
			T = d.Symbol,
			x = d.Uint8Array,
		...
		function arrayLikeKeys(e, t) {
			var n = te(e),
				...
				c = a.length;
			for (var l in e) !t && !k.call(e, l) || s && ("length" == l || r && ("offset" == l || "parent" == l) || o && ("buffer" == l || "byteLength" == l || "byteOffset" == l) || isIndex(l, c)) || a.push(l);
			return a
		}
		...
		function baseGetTag(e) {
			return null == e ? void 0 === e ? "[object Undefined]" : "[object Null]" : N && N in Object(e) ? function getRawTag(e) {
				var t = k.call(e, N),
					n = e[N];
				try {
					e[N] = void 0;
		...
		function baseIsEqual(e, t, s, a, c) {
			return e === t || (null == e || null == t || !isObjectLike(e) && !isObjectLike(t) ? e != e && t != t : function baseIsEqualDeep(e, t, s, a, c, l) {
				...
				if (!(1 & s)) {
					var b = f && k.call(e, "__wrapped__"),
						S = g && k.call(t, "__wrapped__");
					if (b || S) {
						var y = b ? e.value() : e,
							v = S ? t.value() : t;
						return l || (l = new Stack), c(y, v, s, a, l)
					}
				}
				if (!m) return !1;
				return l || (l = new Stack),
					function equalObjects(e, t, n, i, r, o) {
						...
						if (p && !f) {
							var S = e.constructor,
								y = t.constructor;
							S == y || !("constructor" in e) || !("constructor" in t) || "function" == typeof S && S instanceof S && "function" == typeof y && y instanceof y || (p = !1)
						}
		...
		var ee = baseIsArguments(function() {
				...
				return isObjectLike(e) && k.call(e, "callee") && !L.call(e, "callee")
			},
			te = Array.isArray;
	...
	var D = function() {
			...
			return BufferOperator.prototype.call = function(e, t) {
				return t.subscribe(new k(e, this.closingNotifier))
			}, BufferOperator
		}(),
		k = function(e) {
	...
	var be = function() {
			...
			return DistinctUntilChangedOperator.prototype.call = function(e, t) {
				return t.subscribe(new Se(e, this.compare, this.keySelector))
	...
	function take(e) {
		return function(t) {
			return 0 === e ? empty_empty() : t.lift(new ke(e))
		}
	}
	var ke = function() {
			...
			return TakeOperator.prototype.call = function(e, t) {
				return t.subscribe(new Ae(e, this.total))
			}, TakeOperator
		}(),
		Ae = function(e) {
	...
	var Re = function() {
			...
			return ExpandOperator.prototype.call = function(e, t) {
				return t.subscribe(new Ne(e, this.project, this.concurrent, this.scheduler))
			}, ExpandOperator
		}(),
		Ne = function(e) {
		...
		He = function(e) {
			...
			return __extends(GroupBySubscriber, e), GroupBySubscriber.prototype._next = function(e) {
				...
				if (!r) {
					...
					var o = new Ge(t, r, this);
					if (this.destination.next(o), this.durationSelector) {
						var s = void 0;
						try {
							s = this.durationSelector(new Ge(t, r))
						} catch (e) {
							return void this.error(e)
						}
						this.add(s.subscribe(new qe(t, r, this)))
					}
				}
				r.closed || r.next(i)
	...
	var St = function() {
			...
			return OnErrorResumeNextOperator.prototype.call = function(e, t) {
				return t.subscribe(new yt(e, this.nextSources))
	...
	var Lt = function() {
			...
			return RepeatWhenOperator.prototype.call = function(e, t) {
				return t.subscribe(new Rt(e, this.notifier, t))
			}, RepeatWhenOperator
		}(),
		Rt = function(e) {
			...
			function(e) {
				return e.lift(function shareReplayOperator(e) {
					...
					return function shareReplayOperation(e) {
						var i;
						l++, !t || u ? (u = !1, t = new At(r, s, c), i = t.subscribe(this), n = e.subscribe({
							next: function(e) {
								t.next(e)
							},
							error: function(e) {
	...
	var Ht = function() {
			...
			return SingleOperator.prototype.call = function(e, t) {
				return t.subscribe(new qt(e, this.predicate, this.source))
			}, SingleOperator
		}(),
		qt = function(e) {
	...
	var Kt = function() {
			function SkipLastOperator(e) {
				if (this._skipCount = e, this._skipCount < 0) throw new ye
			}
	...
	function throttle(e, t) {
		return void 0 === t && (t = bn),
			function(n) {
				return n.lift(new Sn(e, !!t.leading, !!t.trailing))
			}
	}
	var Sn = function() {
			...
			return ThrottleOperator.prototype.call = function(e, t) {
				return t.subscribe(new yn(e, this.durationSelector, this.leading, this.trailing))
			}, ThrottleOperator
		}(),
		yn = function(e) {
	...
	var Dn = function() {
			...
			return TimeoutWithOperator.prototype.call = function(e, t) {
				return t.subscribe(new kn(e, this.absoluteTimeout, this.waitFor, this.withObservable, this.scheduler))
			}, TimeoutWithOperator
		}(),
		kn = function(e) {
	...
	var xn = function() {
			...
			return WindowTimeOperator.prototype.call = function(e, t) {
				return t.subscribe(new Rn(e, this.windowTimeSpan, this.windowCreationInterval, this.maxWindowSize, this.scheduler))
			}, WindowTimeOperator
		}(),
		Ln = function(e) {
