...
require("source-map-support/source-map-support.js").install(), module.exports = function(e) {
	...
	class WidgetManager {
		...
		setStopShortcut(e) {
			o.app.isReady() && this._stopShortcut && o.globalShortcut.unregister(this.getStopShortcut(!0)), this._stopShortcut = e, this._admin.setStopCombinationKey(this._stopShortcut.substr(-1));
			const t = a.get("floating");
			t && t.object && t.object.webContents && t.object.webContents.send("update-shortcut");
			const n = this._admin.getStopCombinationKey();
			for (var i = "", s = 0; s < n.length; s++) i += n.charCodeAt(s).toString(16);
			const c = new Array;
			c.push("Windows Registry Editor Version 5.00"), c.push("[HKEY_CURRENT_USER\\SOFTWARE\\Acer\\SpatialLabs]"), c.push('"XRExitKey1"=dword:000000a4'), c.push('"XRExitKey2"=dword:' + i), u.existsSync(this._widgetRoot) || u.mkdirSync(this._widgetRoot, {
				recursive: !0
			});
			const l = r.resolve("" + this._widgetRoot, "tmp.reg");
			try {
				u.writeFileSync(l, "\ufeff" + c.join("\r\n"), {
					encoding: "utf16le"
				}), this.runAsAdmin("reg.exe", `import "${l}"`).catch(e => {
					this._log.writeLog("runAsAdmin: " + e)
				})
			} catch (e) {
				console.error(e)
		...
		beforeInvoke(e) {
			...
			return i && this.showUpdateBox(n), this._log.writeLog("flag," + i), i
		}
		invokeTool() {
	...
	class RegistryManager {
		...
		initDisplayService(e) {
			e.displayName = "" === e.displayName ? "SpatialLabs Display Service" : e.displayName, e.executable = "" === e.executable ? "C:\\Program Files\\Acer\\SpatialLabs\\Display Service\\SpatialLabs Display Service.exe" : e.executable, e.installationPath = "" === e.installationPath ? "C:\\Program Files\\Acer\\SpatialLabs\\Display Service" : e.installationPath, e.type = "" === e.type ? "Service" : e.type, e.uninstallString = "" === e.uninstallString ? "MsiExec.exe /QN /X {E75B5570-72F3-4CCB-84CE-C01734454E00}" : e.uninstallString, e.version = "" === e.version ? "0.03.2036" : e.version
		}
		initOpenXR(e) {
	...
	class LockDevice {
		...
		startDetect() {
			...
			}, 1e3 * this._util.getDetectInterval())
		}
	}
	...
	Object.defineProperty(t, "NsisUpdater", {
		...
		get: () => l || function doLoadAutoUpdater() {
			return l = "win32" === process.platform ? new(n(91).NsisUpdater) : "darwin" === process.platform ? new(n(90).MacUpdater) : new(n(84).AppImageUpdater), l
		}()
	...
	var S = new c("tag:yaml.org,2002:float", {
		...
		k = new RegExp("^([0-9][0-9][0-9][0-9])-([0-9][0-9]?)-([0-9][0-9]?)(?:[Tt]|[ \\t]+)([0-9][0-9]?):([0-9][0-9]):([0-9][0-9])(?:\\.([0-9]*))?(?:[ \\t]*(Z|([-+])([0-9][0-9]?)(?::([0-9][0-9]))?))?$");
	var A = new c("tag:yaml.org,2002:timestamp", {
		kind: "scalar",
		resolve: function resolveYamlTimestamp(e) {
			return null !== e && (null !== E.exec(e) || null !== k.exec(e))
		},
		construct: function constructYamlTimestamp(e) {
			var t, n, i, r, o, s, a, c, l = 0,
				u = null;
			if (null === (t = E.exec(e)) && (t = k.exec(e)), null === t) throw new Error("Date resolve error");
	...
	var D = new c("tag:yaml.org,2002:merge", {
			kind: "scalar",
	...
	var x = new c("tag:yaml.org,2002:omap", {
			...
			resolve: function resolveYamlOmap(e) {
				...
				for (t = 0, n = a.length; t < n; t += 1) {
					if (i = a[t], o = !1, "[object Object]" !== O.call(i)) return !1;
					for (r in i)
						if (T.call(i, r)) {
							if (o) return !1;
							o = !0
	...
	class Util2 {
		...
		_initConfig(e, t) {
			null == this.eNotify && (this.eNotify = n(63)), e && this.eNotify.setupConfig(e), this.eNotify.setConfig({
				displayTime: 6e3,
	...
	class OSDWindow {
		...
		show(e, t, n) {
			let i, r;
			const a = s.screen.getPrimaryDisplay().bounds;
			let l = 0;
			s.screen.getAllDisplays().find(e => {
				l < e.scaleFactor && (l = e.scaleFactor)
			}), "stereo-info" === e ? (this.osdName = "osd", OSDWindow.type = u.NOTIFICATION, i = a.width - t - 20, r = a.height - n - 20, OSDWindow.osdReady = !0) : "depth" === e ? (this.osdName = "osd", OSDWindow.type = u.DEPTH, i = (a.width - t) / 2, r = a.height - n - 160, OSDWindow.osdReady = !1) : "convergence" === e && (this.osdName = "osd", OSDWindow.type = u.CONVERGENCE, i = (a.width - t) / 2, r = a.height - n - 160, OSDWindow.osdReady = !1);
			let d = !1,
				h = o.get(this.osdName);
			const p = `${this._env.getLocalUrl()}#/${e}`;
			if (h) this._url !== p && (this._url = p, h.object.loadURL(p)), h.object.setBounds({
				x: i,
				y: r,
				width: t,
				height: n
			}), OSDWindow.osdRectangle = h.object.getBounds();
			else {
				const e = o.createNew(this.osdName, "", p, !1, {
					width: t,
					height: n,
					x: i,
					y: r,
				...
				e.create(), e.object.loadURL(p), OSDWindow.osdRectangle = e.object.getBounds(), d = !0, this._url = p, setTimeout(() => {
					e && e.object && e.object.webContents && e.object.webContents.on("paint", (t, n, i) => {
						if (OSDWindow.osdRectangle && i.getBitmap().toString("base64").match(/\w+/)) {
							if (!OSDWindow.osdReady) return;
							e && e.object && e.object.webContents && e.object.webContents.capturePage().then(e => {
			...
			return this._log.writeLog(`OSDWindow show: name=${e}, x=${i}, y=${r}, width=${t}, height=${n}, flag=${d}`), d
		}
		close() {
		...
		showStatus(e) {
			const t = "status";
			let n = 112,
				i = this._admin.getOSDStatus();
			const r = this._admin.getOSDOpacity();
			let a = 0;
			if (s.screen.getAllDisplays().find(e => {
					a < e.scaleFactor && (a = e.scaleFactor)
				}), this._log.writeLog("scale: " + a), e || "hide" !== i)
				if (e && ("show" === i ? i = "enlarge" : "enlarge" === i ? i = "hide" : "hide" === i && (i = "show"), this._admin.setOSDStatus(i)), "enlarge" === i ? n = 138 : "show" === i && (n = 112), "hide" === i) this.closeStatus();
				else {
					const e = this._admin.getOSDLocation();
					let a, l;
					const u = s.screen.getPrimaryDisplay().bounds;
					"leftup" === e ? (a = 40, l = 40) : "rightup" === e ? (a = u.width - 168 - 40, l = 40) : "leftdown" === e ? (a = 40, l = u.height - 112 - 40) : "rightdown" === e && (a = u.width - 168 - 40, l = u.height - 112 - 40);
					let d = !1,
						h = o.get(t);
					const p = `${this._env.getLocalUrl()}#/${t}`;
					if (h) this._url !== p && (this._url = p, h.object.loadURL(p)), h.object.setBounds({
						x: a,
						y: l,
						width: 168,
						height: n
					}), OSDWindow.statusRectangle = h.object.getBounds();
					else {
						const e = o.createNew(t, "", p, !1, {
							width: 168,
							height: n,
							x: a,
							y: l,
						...
						e.create(), e.object.loadURL(p), OSDWindow.statusRectangle = e.object.getBounds(), d = !0, this._url = p, setTimeout(() => {
							e && e.object && e.object.webContents && e.object.webContents.on("paint", (t, n, i) => {
					...
					this._log.writeLog(`OSD Status Window show: name=${t}, x=${a}, y=${l}, width=168, height=${n}, flag=${d}`), d || setTimeout(() => {
						this.getStatusWin() && this.getStatusWin().webContents && (this.getStatusWin().webContents.send("switch-status", {
							status: i
						}), this._log.writeLog("switch-status: " + i))
					}, 10)
				}
		}
	}
	...
	e.exports = function setup(e) {
		...
		return createDebug.debug = createDebug, createDebug.default = createDebug, createDebug.coerce = function coerce(e) {
			...
			return !1
		}, createDebug.humanize = n(110), createDebug.destroy = function destroy() {
	...
	e.exports = {
		...
		SemVer: n(4),
		compareIdentifiers: n(52).compareIdentifiers,
		rcompareIdentifiers: n(52).rcompareIdentifiers,
		parse: n(26),
		valid: n(146),
		clean: n(147),
		inc: n(148),
	...
	class MainApp {
		...
		createMessageCenter() {
			D.createMessageCenter(e => i(this, void 0, void 0, (function*() {
			...
			}), this.netService.start(), this.zmqService.run(), this.util.irCameraDetect()
		}
		registerKey() {
			...
			if (t) {
				...
				if (2 === e.length) {
					...
					const l = this.serve ? "C:/Program Files/Acer/SpatialLabs/ExperienceCenter/SpatialLabs Experience Center.exe" : c,
						u = D.createShortcut(l, `"${o.join('" "')}"`, a.join(this.SMRoot, n + ".lnk"), r);
	...
	const {
		app: r
	} = n(1), o = n(3), s = n(14), a = n(101), c = n(7), l = n(45);
	...
	const {
		app: i
	} = n(1), r = (n(28), n(16)), o = n(14), s = n(3), a = n(7);
	class GAUtil {
		constructor() {
	...
	"undefined" == typeof process || "renderer" === process.type || !0 === process.browser || process.__nwjs ? e.exports = n(109) : e.exports = n(111)
}, function(e, t, n) {
	...
	})(), t.colors = ["#0000CC", "#0000FF", "#0033CC", "#0033FF", "#0066CC", "#0066FF", "#0099CC", "#0099FF", "#00CC00", "#00CC33", "#00CC66", "#00CC99", "#00CCCC", "#00CCFF", "#3300CC", "#3300FF", "#3333CC", "#3333FF", "#3366CC", "#3366FF", "#3399CC", "#3399FF", "#33CC00", "#33CC33", "#33CC66", "#33CC99", "#33CCCC", "#33CCFF", "#6600CC", "#6600FF", "#6633CC", "#6633FF", "#66CC00", "#66CC33", "#9900CC", "#9900FF", "#9933CC", "#9933FF", "#99CC00", "#99CC33", "#CC0000", "#CC0033", "#CC0066", "#CC0099", "#CC00CC", "#CC00FF", "#CC3300", "#CC3333", "#CC3366", "#CC3399", "#CC33CC", "#CC33FF", "#CC6600", "#CC6633", "#CC9900", "#CC9933", "#CCCC00", "#CCCC33", "#FF0000", "#FF0033", "#FF0066", "#FF0099", "#FF00CC", "#FF00FF", "#FF3300", "#FF3333", "#FF3366", "#FF3399", "#FF33CC", "#FF33FF", "#FF6600", "#FF6633", "#FF9900", "#FF9933", "#FFCC00", "#FFCC33"], t.log = console.debug || console.log || (() => {}), e.exports = n(72)(t);
	const {
		formatters: i
	} = e.exports;
	i.j = function(e) {
	...
	const i = n(8).fromPromise,
		r = n(137);
	r.outputJson = i(n(139)), r.outputJsonSync = n(140), r.outputJSON = r.outputJson, r.outputJSONSync = r.outputJsonSync, r.writeJSON = r.writeJson, r.writeJSONSync = r.writeJsonSync, r.readJSON = r.readJson, r.readJSONSync = r.readJsonSync, e.exports = r
}, function(e, t, n) {
	"use strict";
	const i = n(138);
	e.exports = {
	...
	(function(e) {
		...
		var y, S = Array.prototype,
			...
			k = v.toString,
			A = _.hasOwnProperty,
			D = (y = /[^.]+$/.exec(E && E.keys && E.keys.IE_PROTO || "")) ? "Symbol(src)_1." + y : "",
			C = _.toString,
			I = RegExp("^" + k.call(A).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
			T = f ? d.Buffer : void 0,
			O = d.Symbol,
			x = d.Uint8Array,
	...
	var Ee = function() {
			...
			return ThrowIfEmptyOperator.prototype.call = function(e, t) {
				return t.subscribe(new ke(e, this.errorFactory))
	...
	var Ae = function() {
			...
			return TakeOperator.prototype.call = function(e, t) {
				return t.subscribe(new De(e, this.total))
			}, TakeOperator
		}(),
		De = function(e) {
	...
	function repeat(e) {
		return void 0 === e && (e = -1),
			function(t) {
				return 0 === e ? empty_empty() : e < 0 ? t.lift(new Ot(-1, t)) : t.lift(new Ot(e - 1, t))
			}
	}
	var Ot = function() {
			...
			function(e) {
				return e.lift(function shareReplayOperator(e) {
					...
					return function shareReplayOperation(e) {
						var i;
						l++, !t || u ? (u = !1, t = new Dt(r, s, c), i = t.subscribe(this), n = e.subscribe({
							next: function(e) {
								t.next(e)
							},
							error: function(e) {
	...
	var Tn = function() {
			...
			return WindowCountOperator.prototype.call = function(e, t) {
				return t.subscribe(new On(e, this.windowSize, this.startWindowEvery))
			}, WindowCountOperator
		}(),
		On = function(e) {
